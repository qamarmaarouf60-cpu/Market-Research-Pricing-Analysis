...
class ProductSerializer(serializers.ModelSerializer):
    ...
    def get_price_category(self, obj) -> str:
        """
        Classe le produit en 3 gammes selon son prix.
        Les seuils sont en MAD (Dirhams marocains).
        Adapte ces valeurs selon le type de produit.
        """
        price = float(obj.price_value)
        if price < 1_000:
            return "Bas"
        elif price < 5_000:
            return "Moyen"
